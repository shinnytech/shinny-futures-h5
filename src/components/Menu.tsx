...
const routes = {
  appPages: [
    { title: 'Schedule', path: '/tabs/quote', icon: calendarOutline },
    { title: 'Speakers', path: '/tabs/chart', icon: peopleOutline },
    { title: 'Map', path: '/tabs/trade', icon: mapOutline },
    { title: 'About', path: '/tabs/me', icon: informationCircleOutline }
  ],
  loggedInPages: [
